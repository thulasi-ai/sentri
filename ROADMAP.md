...
| AUTO-012 (backend) | SLA / quality gate enforcement — per-project `qualityGates` config, run-time evaluator, `gateResult` on runs + trigger responses (UI + GH Action tracked as AUTO-012b) | PR #2                                                           |
...
| Phase 4 — Autonomous Intelligence | Risk-based testing, change detection, quality gates | 🔄 In progress — AUTO-005/006/007/012 (backend)/013/016 ✅ (AUTO-016b UI shipped in PR #1; AUTO-012 UI + GH Action carry-over tracked as AUTO-012b); remaining: AUTO-001/002/003/004, AUTO-008–011, AUTO-012b, AUTO-014/015, AUTO-017–019                                | 14–18 weeks |
...
> **Note:** Several Phase 4 items have already shipped opportunistically alongside other work and appear in the Completed Work Summary above — `AUTO-005` (test retry, PR #2), `AUTO-006` (network conditions, PR #3), `AUTO-007` (geolocation/locale/timezone, PR #94), `AUTO-012` backend slice (SLA / quality gate enforcement — evaluator, CRUD endpoints, trigger response; UI + GH Action tracked as AUTO-012b, PR #2), `AUTO-013` (stale test detection, PR #99), `AUTO-016` backend slice (axe-core scan + persistence, PR #121), and `AUTO-016b` (frontend `CrawlView` accessibility panel + dashboard "Top Accessibility Offenders" rollup, PR #1). The remaining ~13 items are scoped here and ready to start; the immediate next sprint item is `DIF-015b Gap 2` (recorder data-testid quality scoring) tracked in `NEXT.md`.
...
| Autonomous Intelligence | 22 | 6 | 0 | 16 | AUTO-001–004, 008–011, 012b, 014, 015, 016b, 017–022 |
